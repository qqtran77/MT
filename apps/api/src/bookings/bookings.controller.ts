import { Controller, Get, Post, Patch, Body, Param, Query, UseGuards, Request, SetMetadata, Optional } from '@nestjs/common';
...
export class BookingsController {
  ...
  @Public()
  @Post() create(@Body() dto: CreateBookingDto, @Request() req) { return this.service.create(dto, req.user || null); }
